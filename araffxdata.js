...
const fakestatus = {
  ...
  return list[Math.floor(list.length * Math.random())]
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await raffx.updateProfileStatus(`I'M ANGGABOTZ | Aktif Selama ${uptime} ⏳ | Mode : ${raffx.public ? 'Public-Mode 👥' : 'Self-Mode 👤'} | User : ${Object.keys(global.db.data.users).length} 👥| DON'T CALL BOTZ! 📞 | © ANGGABOTZ`).catch(_ => _)
