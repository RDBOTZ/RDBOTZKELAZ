...
const fakestatus = {
  ...
  return list[Math.floor(list.length * Math.random())]
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await raffx.updateProfileStatus(`SAYA TEAMS BOT | Aktif Selama ${uptime} ⏳ | Mode : ${raffx.public ? 'Public-Mode 👥' : 'Self-Mode 👤'} | User : ${Object.keys(global.db.data.users).length} 👥| Jangan Telp Bot 📞 | © RAFFX TEAMS`).catch(_ => _)
